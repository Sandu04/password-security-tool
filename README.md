...
# Generate password                 
sudo docker run --rm sandu04/password-tool --length 16 --upper --numbers --special       
              
# Analyze password                
sudo docker run --rm sandu04/password-tool --check "password123" --show              
...
# Basic usage             
sudo docker run --rm sandu04/password-tool --help                 

# Examples            
sudo docker run --rm sandu04/password-tool --length 20              
sudo docker run --rm sandu04/password-tool --memorable --words 3           
sudo docker run --rm sandu04/password-tool --batch 5 --length 12         
